...
const DisabilityFormSection: React.FC<{
  disability: string;
  type: string;
  fieldName: string;
  control: any;
}> = ({ disability, type, fieldName, control }) => {
  const labels = {
  ...
  const options = {
    "Acquired Brain Injury (ABI/TBI)": [
      {
        value: "I have a Disability Assessment Form to upload",
        label: "I have a Disability Assessment Form to upload",
        skip: "Skip to question 26",
      },
      {
        value:
          "My Disability Assessment Form is being submitted by the TMU Medical Centre/my doctor",
        label:
          "My Disability Assessment Form is being submitted by the TMU Medical Centre/my doctor",
        skip: "Skip to question 35",
      },
      {
        value: "I do not have a completed Disability Assessment Form",
        label: "I do not have a completed Disability Assessment Form",
        skip: "Skip to section 32 (Missing Documentation)",
      },
    ],
    "Attention Deficit Hyperactivity Disorder (ADHD)": [
      {
        value:
          "I have a Disability Assessment Form or Psychoeducational Assessment to upload",
        label:
          "I have a Disability Assessment Form or Psychoeducational Assessment to upload",
        skip: "Skip to question 26",
      },
      ...
      {
        value:
          "I do not have a completed Disability Assessment Form or Psychoeducational Assessment",
        label:
          "I do not have a completed Disability Assessment Form or Psychoeducational Assessment",
        skip: "Skip to section 32 (Missing Documentation)",
      },
    ...
    "Learning Disability (LD)": [
      {
        value: "I have a Psychoeducational Assessment to upload",
        label: "I have a Psychoeducational Assessment to upload",
        skip: "Skip to question 30",
      },
      {
        value: "I do not have a completed Psychoeducational Assessment",
        label: "I do not have a completed Psychoeducational Assessment",
        skip: "Skip to section 33 (Missing Documentation: Psychoeducational Assessment)",
      },
    ],
    "Mild Intellectual Disability (MID)": [
      {
    ...
    <FormProvider {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <div>
          ...
          <div>
            <p>
              In this section we ask about your disability(ies) and guide you
              through identifying and submitting the appropriate documentation.
            </p>
            <p>
              Note: Your disability-related documentation is a key piece to your
              registration. This interactive form will identify the requirements
              for your specific disability and request that documents be
              uploaded. If you need to exit the form in order to obtain and/or
              digitize your documentation, you can always return and re-start
              this intake form again.
            </p>
            <p>
              For more information, visit our{" "}
              <a
                className="underline text-blue-600"
                href="https://www.torontomu.ca/accommodations/"
                rel="noreferrer"
              >
                website
              </a>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                3. Please indicate the primary disability that affects your
                academics (select one): *
              </FormLabel>
              <FormControl>
                <RadioGroup
                  onValueChange={field.onChange}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                4. Please indicate all other (secondary) disabilities that
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                5. Please indicate the secondary disability that affects your
                academics (select one): *
              </FormLabel>
              <FormControl>
                <RadioGroup
        ...
        {watch("primaryDisability") && (
          <DisabilityFormSection
            ...
            type="primary"
            control={control}
            fieldName={`${watch("primaryDisability")
              .toLowerCase()
              .replace(/\s/g, "")}FormStatus`}
          />
        )}
        {watch("secondaryDisability") && (
          <DisabilityFormSection
            ...
            type="secondary"
            control={control}
            fieldName={`secondary${watch("secondaryDisability")
              .toLowerCase()
              .replace(/\s/g, "")}FormStatus`}
          />
        )}
